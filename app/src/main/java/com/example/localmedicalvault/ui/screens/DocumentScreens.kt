...
@Composable fun DocumentsListScreen(padding: PaddingValues, docs: List<MedicalDocumentEntity>, patients: List<PatientEntity>, onOpen:(Long)->Unit){
    var filter by remember{mutableStateOf("All")}
    val filters = listOf("All") + patients.map { it.fullName }.take(3) + listOf("LAB_RESULTS","PRESCRIPTION")
